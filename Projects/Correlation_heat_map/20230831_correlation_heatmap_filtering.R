...
corrplot(data_out, method = 'color',type = 'upper',col = COL1('Oranges', 500), col.lim = c(0,1), is.corr = FALSE)# Create a correlation heatmap of RNA-seq data 

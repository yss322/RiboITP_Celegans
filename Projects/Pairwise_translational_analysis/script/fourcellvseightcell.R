...
ribo_cell_new <-  get_region_counts(new.ribo,
                                      range.lower = 25,
                                      range.upper = 35,
                                      experiment = c('4-cell_C','4-cell_D','8-cell_D'),
                                      length      = TRUE,
                                      transcript  = FALSE,
                                      tidy = F,
                                      region      = c("CDS") )
...
setcolorder(rcw_diff_ribo, c('transcript','4cell_A','4cell_B','4-cell_C','4-cell_D','8cell_A','8-cell_D'))
colnames(rcw_diff_ribo)<-c('transcript','4cell_A.RIBO','4cell_B.RIBO','4-cell_C.RIBO','4-cell_D.RIBO','8cell_A.RIBO','8-cell_D.RIBO')
#processing RNA-seq 

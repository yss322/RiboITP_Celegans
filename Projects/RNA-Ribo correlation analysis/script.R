...
filtered_transcripts <- which(rcw[2:9] > 2 )
rcw_filtered         <- rcw[filtered_transcripts, ]
cor(x = rcw_filtered$one_cell_A,y = rcw_filtered$one_cell_B, method = "spearman")
plot(log2(rcw_filtered$one_cell_A), log2(rcw_filtered$one_cell_B), xlab = "Replicate 2 (counts)", ylab = "Replicate 1 (counts)", main = "1-cell replicate RNA correlation", pch = 19, cex = 0.5) + 
  stat_cor(method        = "spearman", 
           aes(label     = ..r.label..), 
           cor.coef.name = "rho", 
           digits        = 2)
...
plot_pairwise_relationships(rcw_filtered, id1 = "one_cell_A", id2 = "one_cell_B", main =  "1-cell replicate RiboITP correlation")
plot_pairwise_relationships(rcw_filtered, id1 = "two_cell_A", id2 = "two_cell_B", main =  "2-cell replicate RiboITP correlation")
...
filtered_transcripts_rna <- which(rna_rcw[2:9] > 2 )

rcw_filtered_rna         <- rna_rcw[filtered_transcripts, ]

plot_pairwise_relationships(rcw_filtered_rna, id1 = "one_cell_A", id2 = "one_cell_B", main =  "1-cell replicate RNA-seq correlation")
plot_pairwise_relationships(rcw_filtered_rna, id1 = "two_cell_A", id2 = "two_cell_B", main =  "2-cell replicate RNA-seq correlation")
plot_pairwise_relationships(rcw_filtered_rna, id1 = "four_cell_A", id2 = "four_cell_B", main =  "4-cell replicate RNA-seq correlation")
plot_pairwise_relationships(rcw_filtered_rna, id1 = "eight_cell_A", id2 = "eight_cell_B", main =  "8-cell replicate RNA-seq correlation")


# Ribo to RNA correlation 
